...
public class TilingTypeN3_33f
   extends TilingType
{
   public TilingTypeN3_33f(){
      super( "N3-33f", 4, SymmetryType.pmg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[5].getX(0)-tiles[11].getX(0);
      offsets[3] = tiles[5].getY(0)-tiles[11].getY(0);
   }
}
