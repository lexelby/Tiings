...
public class TilingTypeN3_37b
   extends TilingType
{
   public TilingTypeN3_37b(){
      super( "N3-37b", 5, SymmetryType.pmg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[7].getX(0)-tiles[15].getX(0);
      offsets[1] = tiles[7].getY(0)-tiles[15].getY(0);
