...
public class TilingTypeN3_41
   extends TilingType
{
   public TilingTypeN3_41(){
      super( "N3-41", 4, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[14].getX(1)-tiles[0].getX(2);
      offsets[3] = tiles[14].getY(1)-tiles[0].getY(2);
   }
}
