...
public class TilingTypeN3_49
   extends TilingType
{
   public TilingTypeN3_49(){
      super( "N3-49", 4, SymmetryType.pmg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[9].getX(1)-tiles[15].getX(0);
      offsets[3] = tiles[9].getY(1)-tiles[15].getY(0);
   }
}
