...
public class TilingTypeN3_53a
   extends TilingType
{
   public TilingTypeN3_53a(){
      super( "N3-53a", 3, SymmetryType.p2 );
      paramMin = new int[]{  0};
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[1].getX(2)-tiles[5].getX(2);
      offsets[3] = tiles[1].getY(2)-tiles[5].getY(2);
      if( os>0 ){
