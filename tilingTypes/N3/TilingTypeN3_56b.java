...
public class TilingTypeN3_56b
   extends TilingType
{
   public TilingTypeN3_56b(){
      super( "N3-56b", 3, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[6].getX(0)-tiles[5].getX(1);
      offsets[1] = tiles[6].getY(0)-tiles[5].getY(1);
