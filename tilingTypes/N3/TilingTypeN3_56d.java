...
public class TilingTypeN3_56d
   extends TilingType
{
   public TilingTypeN3_56d(){
      super( "N3-56d", 3, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[11].getX(0)-tiles[5].getX(2);
      offsets[3] = tiles[11].getY(0)-tiles[5].getY(2);
   }
}
