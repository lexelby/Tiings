...
public class TilingTypeN3_59b
   extends TilingType
{
   public TilingTypeN3_59b(){
      super( "N3-59b", 4, SymmetryType.p2 );
      paramMin = new int[]{  0};
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[5].getX(1)-tiles[3].getX(0);
      offsets[3] = tiles[5].getY(1)-tiles[3].getY(0);
   }
}
