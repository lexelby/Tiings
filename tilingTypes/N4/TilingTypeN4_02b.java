...
public class TilingTypeN4_02b
	extends TilingType
{
	public TilingTypeN4_02b(){
		super( "N4-2b", 4, SymmetryType.pgg);
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[3].getX(0)-tiles[9].getX(1);
      offsets[1] = tiles[3].getY(0)-tiles[9].getY(1);
