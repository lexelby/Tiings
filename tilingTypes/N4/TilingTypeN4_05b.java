...
public class TilingTypeN4_05b
   extends TilingType
{
   public TilingTypeN4_05b(){
      super( "N4-5b", 4, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[1].getX(2)-tiles[5].getX(3);
      offsets[1] = tiles[1].getY(2)-tiles[5].getY(3);
