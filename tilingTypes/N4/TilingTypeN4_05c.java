...
public class TilingTypeN4_05c
   extends TilingType
{
   public TilingTypeN4_05c(){
      super( "N4-5c", 4, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[3].getX(0)-tiles[2].getX(2);
      offsets[3] = tiles[3].getY(0)-tiles[2].getY(2);
   }
}
