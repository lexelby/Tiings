...
public class TilingTypeN4_05d
   extends TilingType
{
   public TilingTypeN4_05d(){
      super( "N4-5d", 4, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[10].getX(3)-tiles[0].getX(0);
      offsets[3] = tiles[10].getY(3)-tiles[0].getY(0);
   }
}
