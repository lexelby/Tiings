...
public class TilingTypeN4_06j
   extends TilingType
{
   public TilingTypeN4_06j(){
      super( "N4-6j", 4, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[11].getX(1)-tiles[5].getX(3);
      offsets[3] = tiles[11].getY(1)-tiles[5].getY(3);
   }
}
