...
public class TilingTypeN4_08c
   extends TilingType
{
   public TilingTypeN4_08c(){
      super( "N4-8c", 4, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[2].getX(1)-tiles[7].getX(2);
      offsets[3] = tiles[2].getY(1)-tiles[7].getY(2);
   }
}
