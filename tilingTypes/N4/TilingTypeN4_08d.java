...
public class TilingTypeN4_08d
   extends TilingType
{
   public TilingTypeN4_08d(){
      super( "N4-8d", 4, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[2].getX(0)-tiles[5].getX(2);
      offsets[3] = tiles[2].getY(0)-tiles[5].getY(2);
   }
}
