...
public class TilingTypeN4_11d
   extends TilingType
{
   public TilingTypeN4_11d(){
      super( "N4-11d", 4, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[4].getX(0)-tiles[5].getX(3);
      offsets[3] = tiles[4].getY(0)-tiles[5].getY(3);
   }
}
