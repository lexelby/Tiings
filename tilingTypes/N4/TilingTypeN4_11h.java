...
public class TilingTypeN4_11h
   extends TilingType
{
   public TilingTypeN4_11h(){
      super( "N4-11h", 4, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[4].getX(3)-tiles[5].getX(0);
      offsets[3] = tiles[4].getY(3)-tiles[5].getY(0);
   }
}
