...
public class TilingTypeN4_11j
   extends TilingType
{
   public TilingTypeN4_11j(){
      super( "N4-11j", 4, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[5].getX(3)-tiles[0].getX(2);
      offsets[3] = tiles[5].getY(3)-tiles[0].getY(2);
   }
}
