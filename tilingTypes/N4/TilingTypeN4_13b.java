...
public class TilingTypeN4_13b
   extends TilingType
{
   public TilingTypeN4_13b(){
      super( "N4-13b", 4, SymmetryType.pmg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[1].getX(1)-tiles[5].getX(1);
      offsets[1] = tiles[1].getY(1)-tiles[5].getY(1);
