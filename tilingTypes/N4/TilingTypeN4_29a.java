...
public class TilingTypeN4_29a
   extends TilingType
{
   public TilingTypeN4_29a(){
      super( "N4-29a", 4, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[0].getX(2)-tiles[2].getX(2);
      offsets[3] = tiles[0].getY(2)-tiles[2].getY(2);
   }
}
