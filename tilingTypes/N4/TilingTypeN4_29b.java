...
public class TilingTypeN4_29b
   extends TilingType
{
   public TilingTypeN4_29b(){
      super( "N4-29b", 4, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[1].getX(2)-tiles[2].getX(2);
      offsets[3] = tiles[1].getY(2)-tiles[2].getY(2);
   }
}
