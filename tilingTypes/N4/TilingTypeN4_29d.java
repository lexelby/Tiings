...
public class TilingTypeN4_29d
   extends TilingType
{
   public TilingTypeN4_29d(){
      super( "N4-29d", 4, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[1].getX(2)-tiles[4].getX(0);
      offsets[3] = tiles[1].getY(2)-tiles[4].getY(0);
   }
}
