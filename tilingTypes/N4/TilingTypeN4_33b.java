...
public class TilingTypeN4_33b
   extends TilingType
   implements IFunction
{
   private double c,d;
   public TilingTypeN4_33b(){
      super( "N4-33b", 4, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[4].getX(1)-tiles[1].getX(2);
      offsets[1] = tiles[4].getY(1)-tiles[1].getY(2);
