...
public class TilingTypeN4_33c
   extends TilingType
   implements IFunction
{
   private double c,d;
   public TilingTypeN4_33c(){
      super( "N4-33c", 4, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[3].getX(1)-tiles[9].getX(0);
      offsets[3] = tiles[3].getY(1)-tiles[9].getY(0);
   }
