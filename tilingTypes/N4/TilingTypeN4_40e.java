...
public class TilingTypeN4_40e
   extends TilingType
{
   public TilingTypeN4_40e(){
      super( "N4-40e: gss paralellogram", 7, SymmetryType.p2 );
   ...
   public void recalcBase(double[] paramValues) {
      ...
      double os3 = w * getParam(paramValues,4)/100;

      baseTile.setPoint(0, 0,  0);
      baseTile.setPoint(1, os1,  0);
      baseTile.setPoint(2, os3,  0);
