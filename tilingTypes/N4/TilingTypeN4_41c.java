...
public class TilingTypeN4_41c
   extends TilingType
{
   public TilingTypeN4_41c(){
      super( "N4-41c: sg trapezium", 7, SymmetryType.pgg );
   ...
   public void recalcBase(double[] paramValues) {
      ...
      baseTile.setPoint(6, 0, ln2/2);
   }
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[1].getX(2)-tiles[0].getX(3);
      offsets[1] = tiles[1].getY(2)-tiles[0].getY(3);
      offsets[2] = tiles[3].getX(0)-tiles[7].getX(6);
      offsets[3] = tiles[3].getY(0)-tiles[7].getY(6);
   }
}
