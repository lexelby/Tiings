...
public class TilingTypeN4_47a
   extends TilingType
{
   public TilingTypeN4_47a(){
      super( "N4-47a: ss zipper", 5, SymmetryType.p2 );

      paramMin = new int[]{  0,  0,  0,  0};
      paramMax = new int[]{ 90,100,100,100};
      paramDef = new int[]{ 60, 66, 20, 60};
      paramName = new String[]{ "Angle", "Relative Length", "Offset 1", "Offset 2" };
   ...
   public void recalcOffsets(double[] paramValues) {
      double os = getParam(paramValues,3)/100.;  // offset
      offsets[0] = tiles[0].getX(3)-tiles[0].getX(0);
      offsets[1] = tiles[0].getY(3)-tiles[0].getY(0);
      offsets[2] = tiles[0].getX(0)-tiles[3].getX(0) + offsets[0] * os;
      offsets[3] = tiles[0].getY(0)-tiles[3].getY(0) + offsets[1] * os;
   }
}
