...
public class TilingTypeN4_47d
   extends TilingType
{
   public TilingTypeN4_47d(){
      super( "N4-47d: mg zipper", 5, SymmetryType.cm );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[0].getX(0)-tiles[3].getX(0);
      offsets[3] = tiles[0].getY(0)-tiles[3].getY(0);
   }
}
