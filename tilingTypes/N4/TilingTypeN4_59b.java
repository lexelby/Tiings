...
public class TilingTypeN4_59b
   extends TilingType
{
   public TilingTypeN4_59b(){
      super( "N4-59b", 4, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[3].getX(2)-tiles[1].getX(1);
      offsets[3] = tiles[3].getY(2)-tiles[1].getY(1);
   }
}
