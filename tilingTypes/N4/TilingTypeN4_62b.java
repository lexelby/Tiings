...
public class TilingTypeN4_62b
   extends TilingType
{
   public TilingTypeN4_62b(){
      super( "N4-62b", 5, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[1].getX(1)-tiles[7].getX(0);
      offsets[3] = tiles[1].getY(1)-tiles[7].getY(0);
   }
}
