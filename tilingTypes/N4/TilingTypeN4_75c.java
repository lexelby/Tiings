...
public class TilingTypeN4_75c
   extends TilingType
{
   public TilingTypeN4_75c(){
      super( "N4-75c: Trisected equilateral triangles", 5, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[2].getX(0)-tiles[10].getX(1);
      offsets[3] = tiles[2].getY(0)-tiles[10].getY(1);
   }
}
