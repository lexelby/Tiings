...
public class TilingTypeN4_76a
   extends TilingType
{
   public TilingTypeN4_76a(){
      super( "N4-76a", 4, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[2].getX(3)-tiles[1].getX(1);
      offsets[3] = tiles[2].getY(3)-tiles[1].getY(1);
   }
}
