...
public class TilingTypeN4_86b
   extends TilingType
{
   public TilingTypeN4_86b(){
      super( "N4-86b", 4, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[9].getX(0)-tiles[5].getX(3);
      offsets[3] = tiles[9].getY(0)-tiles[5].getY(3);
   }
}
