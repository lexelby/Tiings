...
public class TilingTypeN5_01a3
	extends TilingType
{
	public TilingTypeN5_01a3(){
		super( "N5-1a3", 7, SymmetryType.pgg );
   ...
   public void recalcBase(double[] paramValues) {
      ...
      baseTile.setPoint(2,os*w,  0);
      baseTile.setPoint(3,   w,  0);
      baseTile.setPoint(4,w+x4, y4);
      baseTile.setPoint(5,  x3, y3);
