...
public class TilingTypeN5_01ac1
   extends TilingType
{
   public TilingTypeN5_01ac1(){
      super( "N5-1ac1: type 1&2", 5, SymmetryType.pg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[0].getX(3)-tiles[1].getX(1);
      offsets[3] = tiles[0].getY(3)-tiles[1].getY(1);
   }
}
