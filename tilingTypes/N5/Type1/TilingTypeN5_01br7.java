...
public class TilingTypeN5_01br7
   extends TilingType
{
   public TilingTypeN5_01br7(){
      super( "N5-1br7: type 1&2, Piet Ruhe", 5, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[5].getX(1)-tiles[9].getX(3);
      offsets[3] = tiles[5].getY(1)-tiles[9].getY(3);
   }
}
