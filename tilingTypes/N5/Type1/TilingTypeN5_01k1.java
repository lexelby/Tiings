...
public class TilingTypeN5_01k1
   extends TilingType
{
   public TilingTypeN5_01k1(){
      super( "N5-1k1: type 1&2", 5, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[7].getX(0)-tiles[1].getX(2);
      offsets[3] = tiles[7].getY(0)-tiles[1].getY(2);
   }
}
