...
public class TilingTypeN5_01k2
   extends TilingType
{
   public TilingTypeN5_01k2(){
      super( "N5-1k2: type 1&2", 5, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[5].getX(0)-tiles[6].getX(3);
      offsets[1] = tiles[5].getY(0)-tiles[6].getY(3);
      offsets[2] = tiles[11].getX(0)-tiles[1].getX(2);
      offsets[3] = tiles[11].getY(0)-tiles[1].getY(2);
   }
}
