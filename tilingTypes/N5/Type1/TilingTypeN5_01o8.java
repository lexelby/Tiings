...
public class TilingTypeN5_01o8
   extends TilingType
{
   public TilingTypeN5_01o8(){
      super( "N5-1o8", 5, SymmetryType.pmg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[3].getX(2)-tiles[7].getX(2);
      offsets[1] = tiles[3].getY(2)-tiles[7].getY(2);
