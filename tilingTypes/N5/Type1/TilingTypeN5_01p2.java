...
public class TilingTypeN5_01p2
   extends TilingType
{
   public TilingTypeN5_01p2(){
      super( "N5-1p2", 5, SymmetryType.pg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[7].getX(3)-tiles[3].getX(2);
      offsets[1] = tiles[7].getY(3)-tiles[3].getY(2);
