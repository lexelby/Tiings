...
public class TilingTypeN6_05a
   extends TilingType
{
   public TilingTypeN6_05a(){
      super( "N6-5a", 6, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[2].getX(5)-tiles[0].getX(0);
      offsets[1] = tiles[2].getY(5)-tiles[0].getY(0);
