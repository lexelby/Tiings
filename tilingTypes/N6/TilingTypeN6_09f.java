...
public class TilingTypeN6_09f
   extends TilingType
{
   public TilingTypeN6_09f(){
      super( "N6-9f", 6, SymmetryType.pgg);
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[5].getX(1)-tiles[11].getX(2);
      offsets[1] = tiles[5].getY(1)-tiles[11].getY(2);
