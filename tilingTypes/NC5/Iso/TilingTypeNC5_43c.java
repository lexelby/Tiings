...
public class TilingTypeNC5_43c
   extends TilingTypeNC5_43
{
   public TilingTypeNC5_43c(){
      super( "NC5-43c: Split paralellogram", SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[1].getX(0)-tiles[3].getX(2);
      offsets[3] = tiles[1].getY(0)-tiles[3].getY(2);
   }
}
