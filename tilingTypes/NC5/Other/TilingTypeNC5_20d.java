...
public class TilingTypeNC5_20d
   extends TilingType
{
   public TilingTypeNC5_20d(){
      super( "NC5-20d: Split squares", 5, SymmetryType.pmg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[2].getX(0)-tiles[6].getX(0);
      offsets[3] = tiles[2].getY(0)-tiles[6].getY(0);
   }
}
