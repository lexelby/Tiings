...
public class TilingTypeNC5_71a
   extends TilingType
{
   public TilingTypeNC5_71a(){
      super( "NC5-71a", 5, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[3].getX(0)-tiles[4].getX(4);
      offsets[1] = tiles[3].getY(0)-tiles[4].getY(4);
      offsets[2] = tiles[6].getX(0)-tiles[0].getX(2);
      offsets[3] = tiles[6].getY(0)-tiles[0].getY(2);
   }
}
