...
public class TilingTypeNC5_73a
   extends TilingType
{
   public TilingTypeNC5_73a(){
      super( "NC5-73a", 5, SymmetryType.p1 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[1].getX(3)-tiles[1].getX(1);
      offsets[3] = tiles[1].getY(3)-tiles[1].getY(1);
   }
}
