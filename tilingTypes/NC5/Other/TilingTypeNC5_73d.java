...
public class TilingTypeNC5_73d
   extends TilingType
{
   public TilingTypeNC5_73d(){
      super( "NC5-73d", 5, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[4].getX(0)-tiles[5].getX(1);
      offsets[3] = tiles[4].getY(0)-tiles[5].getY(1);
   }
}
