...
public class TilingTypeNC5_08e
   extends TilingType
{
   public TilingTypeNC5_08e(){
      super( "NC5-8e: sawtooth", 5, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[2].getX(4)-tiles[0].getX(1);
      offsets[3] = tiles[2].getY(4)-tiles[0].getY(1);
   }
}
