...
public class TilingTypeNC5_08h
   extends TilingType
{
   public TilingTypeNC5_08h(){
      super( "NC5-8h: sawtooth", 5, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[4].getX(4)-tiles[0].getX(4);
      offsets[1] = tiles[4].getY(4)-tiles[0].getY(4);
