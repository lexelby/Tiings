...
public class TilingTypeNC5_14b
   extends TilingType
{
   public TilingTypeNC5_14b(){
      super( "NC5-14b", 5, SymmetryType.pgg );
   ...
   public void recalcBase(double[] paramValues) {
      ...
      double x3 = x2 + ln3;
      double y3 = y2;
      double x4 = x3 + ln2 * Math.cos( (180-c) * DEG2RAD);
      double y4 = y3 + ln2 * Math.sin( (180-c) * DEG2RAD);
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[2].getX(0)-tiles[1].getX(3);
      offsets[1] = tiles[2].getY(0)-tiles[1].getY(3);
