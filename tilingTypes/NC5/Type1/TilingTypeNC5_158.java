...
public class TilingTypeNC5_158
   extends TilingType
{
   public TilingTypeNC5_158(){
      super( "NC5-158", 5, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[2].getX(4)-tiles[7].getX(2);
      offsets[3] = tiles[2].getY(4)-tiles[7].getY(2);
   }
}
