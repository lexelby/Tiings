...
public class TilingTypeNC5_182c
   extends TilingType
{
   public TilingTypeNC5_182c(){
      super( "NC5-182c", 5, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[3].getX(0)-tiles[5].getX(4);
      offsets[3] = tiles[3].getY(0)-tiles[5].getY(4);
   }
}
