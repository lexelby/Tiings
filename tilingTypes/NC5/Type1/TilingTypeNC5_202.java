...
public class TilingTypeNC5_202
   extends TilingType
{
   public TilingTypeNC5_202(){
      super( "NC5-202", 5, SymmetryType.p2 );
   ...
   public void recalcBase(double[] paramValues) {
      ...
      baseTile.setPoint(2,  2*dx, lna);
      baseTile.setPoint(3,  dx, lna-dx*k);
      baseTile.setPoint(4,  0, lna);
   }
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[0].getX(3)-tiles[1].getX(4);
      offsets[1] = tiles[0].getY(3)-tiles[1].getY(4);
      offsets[2] = tiles[1].getX(1)-tiles[3].getX(2);
      offsets[3] = tiles[1].getY(1)-tiles[3].getY(2);
   }
}
