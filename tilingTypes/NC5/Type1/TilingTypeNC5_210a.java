...
public class TilingTypeNC5_210a
   extends TilingType
{
   public TilingTypeNC5_210a(){
      super( "NC5-210a", 5, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[2].getX(3)-tiles[1].getX(4);
      offsets[1] = tiles[2].getY(3)-tiles[1].getY(4);
