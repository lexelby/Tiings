...
public class TilingTypeNC5_219b
   extends TilingType
{
   public TilingTypeNC5_219b(){
      super( "NC5-219b", 5, SymmetryType.pg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[2].getX(3)-tiles[5].getX(1);
      offsets[3] = tiles[2].getY(3)-tiles[5].getY(1);
   }
}
