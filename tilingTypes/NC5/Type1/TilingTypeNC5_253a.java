...
public class TilingTypeNC5_253a
   extends TilingType
{
   public TilingTypeNC5_253a(){
      super( "NC5-253a", 5, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[5].getX(0)-tiles[0].getX(3);
      offsets[3] = tiles[5].getY(0)-tiles[0].getY(3);
   }
}
