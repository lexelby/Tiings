...
public class TilingTypeNC5_259b
   extends TilingType
{
   public TilingTypeNC5_259b(){
      super( "NC5-259b", 5, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[0].getX(1)-tiles[4].getX(4);
      offsets[3] = tiles[0].getY(1)-tiles[4].getY(4);
   }
