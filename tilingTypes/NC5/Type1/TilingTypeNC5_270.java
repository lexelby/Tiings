...
public class TilingTypeNC5_270
   extends TilingType
{
   public TilingTypeNC5_270(){
      super( "NC5-270", 5, SymmetryType.p2 );
   ...
   public void recalcBase(double[] paramValues) {
      double ln1 = 0.5;
      double ln2 = ln1 * 2 * getParam(paramValues,0)/300;
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[4].getX(4)-tiles[1].getX(0);
      offsets[3] = tiles[4].getY(4)-tiles[1].getY(0);
   }
