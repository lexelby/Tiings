...
public class TilingTypeNC5_33a
   extends TilingType
{
   public TilingTypeNC5_33a(){
      super( "NC5-33a", 5, SymmetryType.p2 );
   ...
   public void recalcBase(double[] paramValues) {
      ...
      double ln = .6;
      double ln2 = ln*(1 + .5 * paramValues[1] / 100);
      double ln3 = 3*ln-ln2;
      double ln4 = ln3-ln2;
      double ln2b = ln2-ln4;
      // Calculate the base triangle:  ln2-ln4 (f) ln3 (b) ln1*2
      double ln1 = calcSide(ln2b,ln3,f)/2;
      double b = calcAngle(2*ln1,ln3,ln2b);
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[3].getX(1)-tiles[0].getX(4);
      offsets[3] = tiles[3].getY(1)-tiles[0].getY(4);
   }
}
