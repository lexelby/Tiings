...
public class TilingTypeNC5_78c
   extends TilingType
{
   public TilingTypeNC5_78c(){
      super( "NC5-78c: Split rectangle", 5, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[0].getX(4)-tiles[0].getX(0) + os * offsets[0];
      offsets[3] = tiles[0].getY(4)-tiles[0].getY(0) + os * offsets[1];
   }
}
