...
public class TilingTypeNC5_01b
   extends TilingType
{
   public TilingTypeNC5_01b(){
      super( "NC5-1b", 5, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[7].getX(0)-tiles[0].getX(4);
      offsets[1] = tiles[7].getY(0)-tiles[0].getY(4);
