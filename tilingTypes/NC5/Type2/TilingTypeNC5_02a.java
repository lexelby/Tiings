...
public class TilingTypeNC5_02a
   extends TilingType
{
   public TilingTypeNC5_02a(){
      super( "NC5-2a", 6, SymmetryType.pg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[3].getX(0)-tiles[1].getX(3);
      offsets[3] = tiles[3].getY(0)-tiles[1].getY(3);
   }
}
