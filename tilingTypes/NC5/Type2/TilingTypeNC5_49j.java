...
public class TilingTypeNC5_49j
   extends TilingType
{
   public TilingTypeNC5_49j(){
      super( "NC5-49j: 60-90-150-30-210", 5, SymmetryType.pg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[0].getX(2)-tiles[3].getX(4);
      offsets[1] = tiles[0].getY(2)-tiles[3].getY(4);
