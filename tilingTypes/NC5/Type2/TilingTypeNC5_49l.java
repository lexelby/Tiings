...
public class TilingTypeNC5_49l
   extends TilingType
{
   public TilingTypeNC5_49l(){
      super( "NC5-49l: 60-90-150-30-210", 5, SymmetryType.pg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[3].getX(2)-tiles[7].getX(4);
      offsets[3] = tiles[3].getY(2)-tiles[7].getY(4);
   }
}
