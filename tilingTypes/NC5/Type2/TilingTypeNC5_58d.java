...
public class TilingTypeNC5_58d
   extends TilingType
{
   public TilingTypeNC5_58d(){
      super( "NC5-58d", 5, SymmetryType.pg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[2].getX(0)-(tiles[0].getX(0)+tiles[0].getX(4))/2;
      offsets[3] = tiles[2].getY(0)-(tiles[0].getY(0)+tiles[0].getY(4))/2;
   }
}
