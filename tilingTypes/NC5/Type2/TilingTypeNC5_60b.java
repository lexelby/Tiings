...
public class TilingTypeNC5_60b
   extends TilingType
{
   public TilingTypeNC5_60b(){
      super( "NC5-60b", 5, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[6].getX(2)-tiles[2].getX(4);
      offsets[1] = tiles[6].getY(2)-tiles[2].getY(4);
