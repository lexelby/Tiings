...
public class TilingTypeNC5_62b
   extends TilingType
{
   public TilingTypeNC5_62b(){
      super( "NC5-62b", 5, SymmetryType.pmg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[2].getX(1)-tiles[6].getX(1);
      offsets[3] = tiles[2].getY(1)-tiles[6].getY(1);
   }
}
