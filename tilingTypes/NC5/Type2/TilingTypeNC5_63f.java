...
public class TilingTypeNC5_63f
   extends TilingTypeNC5_63
{
   public TilingTypeNC5_63f(){
      super( "NC5-63f", 7, SymmetryType.pgg );
   ...
   public void recalcBase(double[] paramValues) {
      ...
      baseTile.setPoint(6,  0, lnb/2);
   }
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[0].getX(4)-tiles[0].getX(0);
      offsets[1] = tiles[0].getY(4)-tiles[0].getY(0);
      offsets[2] = tiles[3].getX(6)-tiles[7].getX(0);
      offsets[3] = tiles[3].getY(6)-tiles[7].getY(0);
   }
}
