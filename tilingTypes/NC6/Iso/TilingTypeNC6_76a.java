...
public class TilingTypeNC6_76a
   extends TilingType
{
   public TilingTypeNC6_76a(){
      super( "NC6-76a", 6, SymmetryType.p4 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[1].getX(3)-tiles[0].getX(3);
      offsets[3] = tiles[1].getY(3)-tiles[0].getY(3);
   }
}