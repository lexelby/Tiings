...
public class TilingTypeNC6_79b
   extends TilingType
{
   public TilingTypeNC6_79b(){
      super( "NC6-79b", 7, SymmetryType.pg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[1].getX(0)-tiles[0].getX(4);
      offsets[3] = tiles[1].getY(0)-tiles[0].getY(4);
   }
}