...
public class TilingTypeNC6_79f
   extends TilingType
{
   public TilingTypeNC6_79f(){
      super( "NC6-79f", 8, SymmetryType.p2 );

      paramMin = new int[]{  0,  0,  0,  0,  0,  0};
      paramMax = new int[]{100,100,180,180,100,100};
      paramDef = new int[]{ 50, 70,100,130, 20, 40};
