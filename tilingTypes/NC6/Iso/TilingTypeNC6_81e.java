...
public class TilingTypeNC6_81e
   extends TilingType
{
   public TilingTypeNC6_81e(){
      super( "NC6-81e", 8, SymmetryType.pgg );
      ...
      info = "d=f\nA+B=180\nD+E=360\n(C+F=180)";
      labels = new int[]{0,1,2,3,4,5,-1,-1};
   }
   ...
   public void recalcBase(double[] paramValues) {
      ...
      baseTile.setPoint(6,  ln23*c, ln23*s);
      baseTile.setPoint(7,  ln23/2*c, ln23/2*s);
   }
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[1].getX(1)-tiles[0].getX(0);
      offsets[1] = tiles[1].getY(1)-tiles[0].getY(0);
      offsets[2] = tiles[0].getX(1)-tiles[3].getX(7);
      offsets[3] = tiles[0].getY(1)-tiles[3].getY(7);
   }
}