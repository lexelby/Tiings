...
public class TilingTypeNC6_81f
   extends TilingType
{
   public TilingTypeNC6_81f(){
      super( "NC6-81f", 6, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[0].getX(1)-tiles[2].getX(0);
      offsets[1] = tiles[0].getY(1)-tiles[2].getY(0);
