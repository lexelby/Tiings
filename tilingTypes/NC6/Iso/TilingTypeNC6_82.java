...
public class TilingTypeNC6_82
   extends TilingType
{
   public TilingTypeNC6_82(){
      super( "NC6-82", 6, SymmetryType.p6 );

      paramMin = new int[]{  0,  0,-120};
      paramMax = new int[]{100, 60, 120};
      paramDef = new int[]{ 50, 10,  30};
   ...
   public void recalcBase(double[] paramValues) {
      ...
      double x5 = -y5 * Math.tan((ang1-30) * DEG2RAD);
      
      double ang2 = getParam(paramValues,2);
      double c = Math.cos((ang1-30+ang2)*DEG2RAD);
      double s = Math.sin((ang1-30+ang2)*DEG2RAD);
      double px = ln * c60/s60;
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[4].getX(3)-tiles[0].getX(3);
      offsets[3] = tiles[4].getY(3)-tiles[0].getY(3);
   }
}