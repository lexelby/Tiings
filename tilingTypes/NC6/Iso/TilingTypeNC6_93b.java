...
public class TilingTypeNC6_93b
   extends TilingType
{
   public TilingTypeNC6_93b(){
      super( "NC6-93b", 6, SymmetryType.cmm );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[1].getX(4)-tiles[3].getX(4);
      offsets[3] = tiles[1].getY(4)-tiles[3].getY(4);
   }
}