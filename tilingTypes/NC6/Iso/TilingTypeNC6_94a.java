...
public class TilingTypeNC6_94a
   extends TilingType
{
   public TilingTypeNC6_94a(){
      super( "NC6-94a", 6, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[0].getX(2)-tiles[1].getX(3) + os * offsets[0];
      offsets[3] = tiles[0].getY(2)-tiles[1].getY(3) + os * offsets[1];
   }
}