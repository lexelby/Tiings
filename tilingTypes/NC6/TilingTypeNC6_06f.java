...
public class TilingTypeNC6_06f
   extends TilingType
{
   public TilingTypeNC6_06f(){
      super( "NC6-6f", 6, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[3].getX(0)-tiles[4].getX(1);
      offsets[1] = tiles[3].getY(0)-tiles[4].getY(1);
