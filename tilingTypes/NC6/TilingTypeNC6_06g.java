...
public class TilingTypeNC6_06g
   extends TilingType
{
   public TilingTypeNC6_06g(){
      super( "NC6-6g", 6, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[1].getX(1)-tiles[4].getX(0);
      offsets[1] = tiles[1].getY(1)-tiles[4].getY(0);
