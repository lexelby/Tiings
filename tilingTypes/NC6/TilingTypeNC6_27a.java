...
public class TilingTypeNC6_27a
   extends TilingType
{
   public TilingTypeNC6_27a(){
      super( "NC6-27a", 6, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[0].getX(0)-tiles[3].getX(5);
      offsets[3] = tiles[0].getY(0)-tiles[3].getY(5);
   }
}