...
public class TilingTypeNC6_38b
   extends TilingType
{
   public TilingTypeNC6_38b(){
      super( "NC6-38b", 6, SymmetryType.p2 );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[2].getX(5)-tiles[0].getX(1);
      offsets[1] = tiles[2].getY(5)-tiles[0].getY(1);
