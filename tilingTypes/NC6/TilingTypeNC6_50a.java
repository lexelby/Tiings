...
public class TilingTypeNC6_50a
   extends TilingType
{
   public TilingTypeNC6_50a(){
      super( "NC6-50a", 6, SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[7].getX(5)-tiles[0].getX(0);
      offsets[3] = tiles[7].getY(5)-tiles[0].getY(0);
   }
}