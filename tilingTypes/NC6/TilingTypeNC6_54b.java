...
public class TilingTypeNC6_54b
   extends TilingType
{
   public TilingTypeNC6_54b(){
      super( "NC6-54b", 8, SymmetryType.pmg );
      ...
      info = "a=c\nb=e\nd=f\nA+B=180\nC+F=360\n(D+E=180)";
      labels = new int[]{0,-1,-1,1,2,3,4,5};
   }
   ...
   public void recalcBase(double[] paramValues) {
      ...
      baseTile.setPoint(6, c1+c2, s1+s2);
      baseTile.setPoint(7, c1, s1);
   }
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[0].getX(3)-tiles[0].getX(0);
      offsets[1] = tiles[0].getY(3)-tiles[0].getY(0);
      offsets[2] = tiles[3].getX(5)-tiles[7].getX(5);
      offsets[3] = tiles[3].getY(5)-tiles[7].getY(5);
   }
}