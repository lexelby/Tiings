...
public class TilingTypeNC6_54f
   extends TilingType
{
   public TilingTypeNC6_54f(){
      super( "NC6-54f", 8, SymmetryType.pmg );
   ...
   public void recalcBase(double[] paramValues) {
      ...
      baseTile.setPoint(3, ln1 + c1, s1);
      baseTile.setPoint(4, ln1+c1+c2, s1+s2);
      baseTile.setPoint(5, os2+c1+c2, s1+s2);
