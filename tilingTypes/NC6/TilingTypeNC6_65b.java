...
public class TilingTypeNC6_65b
   extends TilingType
{
   public TilingTypeNC6_65b(){
      super( "NC6-65b", 8, SymmetryType.pgg );
   ...
   public void recalcBase(double[] paramValues) {
      ...
      baseTile.setPoint(4, w+c*ln1, s*ln1);
      baseTile.setPoint(5, x+c*y, s*y);
      baseTile.setPoint(6, w-x + c*(h-y), s*(h-y));
      baseTile.setPoint(7, c*ln2, s*ln2);
   }
