...
public class TilingTypeP4_49
   extends TilingType
{
   public TilingTypeP4_49(){
      super( "P4-49: Radially dissected squares 2", 4, SymmetryType.p4g );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = tiles[6].getX(0)-tiles[0].getX(0);
      offsets[3] = tiles[6].getY(0)-tiles[0].getY(0);
   }
}
