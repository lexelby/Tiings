...
public class TilingTypeP5_01
	extends TilingType
{
	public TilingTypeP5_01(){
		super( "P5-1&14: Type 1, Pentagon zipper pattern, half offset", 5, SymmetryType.pg );
   ...
   public void recalcOffsets(double[] paramValues) {
      ...
      offsets[2] = (tiles[1].getX(0)+tiles[1].getX(1))/2-tiles[0].getX(0);
      offsets[3] = (tiles[1].getY(0)+tiles[1].getY(1))/2-tiles[0].getY(0);
   }
}
