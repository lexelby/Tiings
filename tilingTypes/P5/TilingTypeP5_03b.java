...
public class TilingTypeP5_03b
   extends TilingType
{
   public TilingTypeP5_03b(){
      super( "P5-3b: Special case of P5-11", 5 , SymmetryType.pgg );
   ...
   public void recalcOffsets(double[] paramValues) {
      offsets[0] = tiles[2].getX(4)-tiles[0].getX(2);
      offsets[1] = tiles[2].getY(4)-tiles[0].getY(2);
